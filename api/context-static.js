...
// =============================================================================
// SEÇÃO 0 — FUNCIONALIDADES DO APP UNASLAF
// =============================================================================
// Este documento descreve o próprio sistema para que a IA possa explicar
// ao associado como usar o app, o que cada tela faz e como resolver dúvidas.
//
// COMO EDITAR:
// - Se adicionar uma nova tela ou funcionalidade ao app, descreva-a aqui
//   para que a IA passe a explicar ao associado automaticamente.
// - Mantenha a linguagem simples — este conteúdo é explicado ao usuário final.
// =============================================================================

DOCS.push({
  id: 'app_funcionalidades',
  title: 'Funcionalidades do App UNASLAF',
  category: 'app',
...
Ele permite que o associado interaja com a UNASLAF de forma prática e segura.

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
COMO ACESSAR O APP
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
- Acesse pelo link fornecido pela UNASLAF no navegador do celular ou computador.
- Na tela de entrada, informe seu CPF (apenas números ou com pontuação).
- Se o CPF estiver cadastrado, o sistema libera o acesso automaticamente.
- Não há senha — o CPF é a chave de acesso.
- Caso o CPF não seja reconhecido, entre em contato com a UNASLAF pelo site
  unaslaf.org.br para verificar seu cadastro.

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
TELA 1 — ATENDIMENTO (Chat com IA)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
- É a tela principal do app — o chat com a inteligência artificial.
- O associado pode digitar qualquer dúvida sobre a UNASLAF e receber
  uma resposta imediata, baseada nos documentos oficiais da associação.
- Atalhos rápidos (chips): botões com os temas mais consultados,
  como "Ações coletivas", "ADI 4151", "Como me filiar", etc.
  Basta clicar para enviar a pergunta automaticamente.
- Aviso importante: as respostas têm caráter orientativo. Para situações
  individuais ou jurídicas, o associado deve contatar o jurídico da UNASLAF.
- A IA responde sobre: estatuto, ações coletivas, ADI 4151, portarias,
  filiação, direitos dos associados, funcionamento do próprio app, e mais.

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
TELA 2 — MEU CADASTRO
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
- Permite que o associado visualize e atualize seus dados cadastrais.
- Campos que PODEM ser editados pelo associado:
    Nome completo, Aposentado (Sim/Não), E-mail, Telefone/WhatsApp,
    Logradouro, Número, Complemento, Bairro, Cidade, CEP, UF.
- Campos que NÃO podem ser alterados pelo associado (somente leitura):
    CPF e SIAPE — alterações nesses campos devem ser solicitadas à UNASLAF.
- Campos obrigatórios para salvar: Nome, E-mail e Telefone.
  O botão "Salvar Cadastro" fica desabilitado enquanto algum deles estiver vazio.
- Campos opcionais vazios NÃO apagam os dados que já estavam salvos
  (o sistema faz uma atualização inteligente — só sobrescreve o que foi preenchido).
- Toda alteração salva fica registrada automaticamente na aba "Historico"
  da planilha da UNASLAF, com data, hora e nome do responsável.

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
TELA 3 — DOCUMENTOS
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
- Repositório de documentos disponibilizados pela UNASLAF para download.
- O associado pode buscar por nome ou filtrar por categoria.
- Categorias disponíveis: Filiação, Desfiliação, Procuração,
  Requerimentos, Formulários, Geral.
- Para baixar: clique no botão "Baixar" ao lado do documento desejado.
- Os documentos são atualizados automaticamente quando a UNASLAF
  adiciona novos arquivos — não é necessário atualizar o app.

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
SEGURANÇA E PRIVACIDADE
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
- O acesso é restrito a associados com CPF cadastrado na base da UNASLAF.
- Todas as comunicações são criptografadas (HTTPS).
- CPF e SIAPE não podem ser alterados pelo associado no app.
- A sessão expira automaticamente após 8 horas de inatividade.
- O histórico de alterações cadastrais fica registrado na planilha interna.

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
DÚVIDAS E SUPORTE
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
- Para problemas de acesso ou CPF não reconhecido: unaslaf.org.br
- Para dúvidas jurídicas: juridico@unaslaf.org.br
- Para atendimento geral: unaslaf@unaslaf.org.br
`
});
